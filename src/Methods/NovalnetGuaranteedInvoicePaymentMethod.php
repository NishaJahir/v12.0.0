 ...
 */
class NovalnetGuaranteedInvoicePaymentMethod extends PaymentMethodBaseService
{
     use Loggable;
    /**
    ...
    {
       if ($this->config->get('Novalnet.novalnet_guaranteed_invoice_payment_active') == 'true') {
    ...
    {
        $paymentName = trim($this->config->get('Novalnet.novalnet_guaranteed_invoice_payment_name'));
        return ($paymentName ? $paymentName : $this->paymentHelper->getTranslatedText('novalnet_guaranteed_invoice'));
    }
    ...
    {
        $logoUrl = $this->config->get('Novalnet.novalnet_guaranteed_invoice_payment_logo');
    ...
    {
        return 'Novalnet '. $this->paymentHelper->getTranslatedText('novalnet_guaranteed_invoice');
    }
