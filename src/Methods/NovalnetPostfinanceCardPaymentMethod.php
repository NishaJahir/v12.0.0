 ...
 */
class NovalnetPostfinanceCardPaymentMethod extends PaymentMethodBaseService
{
    /**
    ...
    {
       if ($this->config->get('Novalnet.novalnet_postfinance_card_payment_active') == 'true') {
        return (bool)($this->paymentService->isPaymentActive($this->basket, 'novalnet_postfinance_card'));
       }
        return false;
    }
    ...
    {
        $paymentName = trim($this->config->get('Novalnet.novalnet_postfinance_card_payment_name'));
        return ($paymentName ? $paymentName : $this->paymentHelper->getTranslatedText('novalnet_postfinance_card'));
    }
    ...
    {
        $logoUrl = $this->config->get('Novalnet.novalnet_postfinance_card_payment_logo');
        if($logoUrl == 'images/novalnet_postfinance_card.png')
        {
            /** @var Application $app */
            $app = pluginApp(Application::class);
            $logoUrl = $app->getUrlPath('novalnet') .'/images/novalnet_postfinance_card.png';
        }
        return $logoUrl;
    }
    ...
    {
        return 'Novalnet '. $this->paymentHelper->getTranslatedText('novalnet_postfinance_card');
    }
     ...
     */
     public function getBackendIcon():string 
     {
        /** @var Application $app */
        $app = pluginApp(Application::class);
        $logoUrl = $app->getUrlPath('novalnet') .'/images/logos/novalnet_postfinance_card_backend_icon.svg';
        return $logoUrl;
    }
}
