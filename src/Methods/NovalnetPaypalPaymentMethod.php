...
class NovalnetPaypalPaymentMethod extends PaymentMethodBaseService
{
    ...
    public function isActive():bool
    {
        if ($this->config->get('Novalnet.novalnet_paypal_payment_active') == 'true') {
            return (bool)($this->paymentService->isPaymentActive($this->basket, 'novalnet_paypal'));
        }
        return false;
    }
    ...
    public function getDescription(string $lang = 'de'):string
    {
        ...
        return ($description ? $description : $this->paymentHelper->getTranslatedText('redirectionalPaymentDescription'));
    }
    ...
    {
        return 'Novalnet '. $this->paymentHelper->getTranslatedText('novalnet_paypal');
    }
