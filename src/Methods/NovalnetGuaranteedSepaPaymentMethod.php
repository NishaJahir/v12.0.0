 ...
 */
class NovalnetGuaranteedSepaPaymentMethod extends PaymentMethodBaseService
{
    /**
    ...
    {
       if ($this->config->get('Novalnet.novalnet_guaranteed_sepa_payment_active') == 'true') {
    ...
    {
        $paymentName = trim($this->config->get('Novalnet.novalnet_guaranteed_sepa_payment_name'));
        return ($paymentName ? $paymentName : $this->paymentHelper->getTranslatedText('novalnet_guaranteed_sepa'));
    }
    ...
    {
        $logoUrl = $this->config->get('Novalnet.novalnet_guaranteed_sepa_payment_logo');
    ...
    {
        return 'Novalnet '. $this->paymentHelper->getTranslatedText('novalnet_guaranteed_sepa');
    }
